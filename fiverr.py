...
# "\n"+
#                                                 "You can implement the strategies right away and start gaining fans within the first week. PLEASE DM me for more details! ⚡️")#             print("CLIENT 13 message sent to group" + str(group))
